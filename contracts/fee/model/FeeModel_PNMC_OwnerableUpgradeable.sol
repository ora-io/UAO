...
abstract contract FeeModel_PNMC_OwnerableUpgradeable is
    IFeeModel,
    ...
    AsyncOracleUpgradeable
{
    ...
    function _estimateFee(Request storage _request)
        internal
        view
        override(ProtocolFeeUpgradeable, NodeFeeUpgradeable, ModelFeeUpgradeable, CallbackFee)
        returns (uint256)
    {
        return ProtocolFeeUpgradeable._estimateFee(_request) + ModelFeeUpgradeable._estimateFee(_request) + NodeFeeUpgradeable._estimateFee(_request)
    ...
    function _estimateFeeMemory(Request memory _request)
        ...
        returns (uint256)
    {
        return ProtocolFeeUpgradeable._estimateFeeMemory(_request) + ModelFeeUpgradeable._estimateFeeMemory(_request)
            + NodeFeeUpgradeable._estimateFeeMemory(_request) + CallbackFee._estimateFeeMemory(_request);
        ...
        returns (uint256)
    {
        ...
        _remaining = NodeFeeUpgradeable._recordRevenue(_request, _remaining);
    ...
    function _recordCallbackFeeToNodeFee(Request storage _request, uint256 _remaining) internal returns (uint256) {
        ...
        NodeFeeUpgradeable._addRequestNodeFeeCache(_request.requestId, cbfee);
